...
class Gradient8Bit(pattern.Pattern):
    """Gradient8Bit Pattern Class."""
    ...
    def _set_data_output_w_repeat(
        ...
        for repeate_index in xrange(0, self.repeate_count):
            ...
            for pixel_values_index in xrange(self.color_channels_count):
                ...
                # write data
                data_output[output_channel_index] = (
                    pixel_values_8bit[pixel_values_index]
                )
